...
class MapActivity : AppCompatActivity(), OnMapReadyCallback, LocationListener, GoogleMap.OnMapLongClickListener, GoogleMap.OnMapClickListener {
    ...
    override fun onLocationChanged(location: Location) {
        ...
        val index = intent.getIntExtra("SPINNER_ITEM", 0)
        ...
        */
        ...
        stats = "Type: ${activityTypes[index]}\n" +
    ...
    private fun onSaveButtonClick(){
        //GPS mode, input type = 1
        exerciseEntry.inputType = 1
        //Get the activity type from StartTabFragment
        var activityType = intent.getIntExtra("SPINNER_ITEM", 0)
